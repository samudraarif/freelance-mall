                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="#" class="row g-3 align-items-center">
                            <div class="col-md-4">
                                ...
                                <select name="category" class="form-select custom-input" id="category"
                                    aria-label="Select category">
                                    <option value="">Select Category</option>
                                    @foreach ( $dataCategory as $item)
                                        <option value="{{ $item['TENANT_CATEGORY'] }}">{{ $item['TENANT_CATEGORY'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label for="floor" class="form-label">Floor</label>
                                <select name="floor" class="form-select custom-input" id="floor"
                                    aria-label="Select floor">
                                    <option value="">Select Floor</option>
                                    @foreach ( $dataFloor as $item)
                                    <option value="{{ $item['TENANT_FLOOR'] }}">{{ $item['TENANT_FLOOR'] }}</option>
                                @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" name="tenant_name" class="form-control custom-input"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="header-text"><i class="fas fa-map-marker-alt me-2"></i>KH. Noer Ali Mall Metropolitan Building
                        South Bekasi 17148</p>
